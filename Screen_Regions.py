...
def load_default_calib_data() -> dict[str, MyRegion]:
    ...
    default_regions = {
        ...
        "EDInternalStatusPanel.panel_bounds2": {
            ...
            "readonly": False},
        "EDInternalStatusPanel.tab_bar": {"rect": [0.0, 0.0, 1.0, 0.08],
            "text": "The size of the Tab Bar within the panel region.",
            "readonly": False},
        "EDInternalStatusPanel.sts_pnl_tab": {'rect': [0.0, 0.0, 0.15, 0.7],
            "text": "The size of the tab within the tab bar region.",
            "readonly": False},
        ...
        "EDNavigationPanel.panel_bounds2": {
            ...
            "text": "1. Open Navigation Panel.\n2. Size the rectangle from the bottom left corner of the nav panel to the top right corner.",
            "readonly": False},
        "EDNavigationPanel.tab_bar": {"rect": [0.0, 0.0, 1.0, 0.08],
            "text": "The size of the Tab Bar within the panel region.",
            "readonly": False},
        "EDNavigationPanel.location_panel": {"rect": [0.2218, 0.3, 0.8, 1.0],
            "text": "The Location Panel within the Nav Panel region.",
            "readonly": False},
        "EDNavigationPanel.nav_pnl_tab": {'rect': [0.0, 0.0, 0.23, 0.7],
            "text": "The size of the tab within the tab bar region.",
            "readonly": False},
        "EDNavigationPanel.nav_pnl_location": {'rect': [0.0, 0.0, 1.0, 0.08],
            "text": "The size of the location line within the location panel region.",
            "readonly": False},
