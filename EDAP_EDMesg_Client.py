...
class EDMesgClient:
    ...
    def _handle_undock_complete(self):
        print(f"Handling Event: UndockCompleteEvent")
        # Implement the event handling logic here

    def send_undock_action(self):
        """ Send an action request to EDAP. """
        print("Sending Action: UndockAction.")
        self.client.publish(UndockAction())
