    ...
    def loop(self, ap):
        ...
        while True:
            ...
            if self.state == STATE_MISSIONS:
                ...
                dest = ap.waypoint.set_gal_map_destination_text(ap, "SOTHIS ", target_select_cb=ap.jn.ship_state)
                ...
                dest = ap.waypoint.set_gal_map_destination_text(ap, "ROBIGO", target_select_cb=ap.jn.ship_state)
                sleep(2)
